...
public class LoseScreen implements Screen {
    ...
    public LoseScreen(AngryBirds game, int score, int level) {
        this.game = game;
        this.score = score;
        this.level = level;

        loseBG = new Texture("backgrounds/playBG.jpg");
        loseMenu = new Texture("losePic.png");
    ...
    public void render(float delta) {
        ...
        Sprite sprite = new Sprite(loseMenu);
        sprite.setPosition(AngryBirds.V_WIDTH / 2 - sprite.getWidth() / 2, AngryBirds.V_HEIGHT / 2 + sprite.getHeight() / 10);
